...
public enum ConfigPropertyConstants {
    ...
    SCANNER_NEXUSIQ_ENABLED("scanner", "nexusiq.enabled", "false", PropertyType.BOOLEAN, "Flag to enable/disable Sonatype Nexus IQ Vulnerability Analysis"),
    SCANNER_NEXUSIQ_ALIAS_SYNC_ENABLED("scanner", "nexusiq.alias.sync.enabled", "false", PropertyType.BOOLEAN, "Flag to enable/disable alias synchronization for Sonatype Nexus IQ"),
    SCANNER_NEXUSIQ_USER_TOKEN("scanner", "nexusiq.api.userToken", null, PropertyType.ENCRYPTEDSTRING, "The User token used for Sonatype Nexus IQ API authentication in the format of `[userCode]:[passCode]`"),
    //SCANNER_NEXUSIQ_ORG_ID("scanner", "nexusiq.org.id", null, PropertyType.STRING, "The Organization ID (not the display name) used for Sonatype Nexus IQ API access"),
    SCANNER_NEXUSIQ_ORG_APP_ID("scanner", "nexusiq.org.app.id", "dependency-track", PropertyType.STRING, "The default App ID used to evaluate results"),
    SCANNER_NEXUSIQ_BASE_URL("scanner", "nexusiq.base.url", null, PropertyType.URL, "Base Url pointing to the hostname and path for Sonatype Nexus IQ"),
    SCANNER_NEXUSIQ_REPORT_PERIOD("scanner", "nexusiq.report.period","120", PropertyType.NUMBER, "How long to wait for Nexus IQ evaluation request results"),
